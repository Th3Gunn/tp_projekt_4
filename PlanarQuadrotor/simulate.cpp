...
void plot(std::vector<float>&x, std::vector<float>&y, std::vector<float>&theta)
{
        ...
        while (!quit)
        {
            ...
            while (SDL_PollEvent(&e) != 0)
            {
                ...
                else if (e.type == SDL_MOUSEMOTION)
                {
                    ...
                    x_point=float(x)/SCREEN_WIDTH;
                    y_point=float(y)/SCREEN_HEIGHT;
                ...
                {
                    plot(x_history, y_history, theta_history);
                }
